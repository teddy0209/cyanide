...
- (void)buildTweakDocsInStack:(UIStackView *)stack
{
    ...
    [stack addArrangedSubview:[self docCard:@"RemoteCall API"
        body:@"These functions are injected into every JS context:\n\n"
              ...
              "  Send an ObjC message. Up to 4 args. Common UIKit creation and\n"
              "  visual mutation selectors are automatically sent on the main thread.\n\n"
              "r_msg2_main(target, selector, a1, a2, a3, a4)\n"
              "  Same but forced onto the main thread.\n"
              "  Required for all UIKit/view changes.\n\n"
              "r_overlay_claim(view) -> bool\n"
              "  Track a remotely created overlay for cleanup on rerun or disable.\n\n"
              "r_overlay_release(view) -> bool\n"
              "  Remove a tracked overlay immediately.\n\n"
              "Views allocated by this script and attached with addSubview: or\n"
              "insertSubview: are tracked automatically.\n\n"
...
- (NSString *)tweakMarkdown
{
    ...
    "| `r_overlay_claim(view)` | Track overlay for automatic cleanup |\n"
    "| `r_overlay_release(view)` | Remove and untrack overlay |\n"
    "| `r_responds(t,s)` | respondsToSelector check |\n\n"
    "Common UIKit creation and visual mutation selectors sent through `r_msg2` are automatically serialized onto SpringBoard's main thread. Script-created views attached with `addSubview:` or `insertSubview:` are removed when that script reruns or is disabled.\n\n"
    "## QuickLoader Prefs\n\n"
